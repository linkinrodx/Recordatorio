...
public class ReminderEditActivity extends AppCompatActivity implements
    ...
    public void selectRepeatType(View v){
        ...
        builder.setTitle("Seleeciona el Tipo");
    ...
    public void setRepeatNo(View v){
        ...
        alert.setTitle("Ingresar Numero");
    ...
    public void updateReminder(){
        ...
        } else if (mRepeatType.equals("Mes")) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0)
                    mTitleText.setError("El titulo del recordatorio no puede estar en blanco");
            ...
            case R.id.discard_reminder:
                Toast.makeText(getApplicationContext(), "Cambios Cancelados",
                        Toast.LENGTH_SHORT).show();
